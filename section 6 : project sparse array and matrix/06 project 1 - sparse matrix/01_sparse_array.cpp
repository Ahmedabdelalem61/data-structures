...
private:
	...
	int array_length { };	//number of array elements
...
void test_index() {
	...
	array.set_value(10, 2);
	array.set_value(20, 4);
	array.set_value(30, 6);
	array.set_value(50, 8);
	array.print_array();
	cout << array.get_value(2) << "\n";

	ArrayLinkedList array2(10);
	array2.set_value(1, 2);
	array2.set_value(1, 4);
	array2.set_value(1, 6);
	array2.set_value(1, 8);

	array.add(array2);
	array.print_array();
	//0 0 10 0 20 0 30 0 50 0 
    //10
    //0 0 11 0 21 0 31 0 51 0 
}
